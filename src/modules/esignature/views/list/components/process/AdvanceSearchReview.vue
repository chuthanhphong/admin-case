  ...
  data() {
    return {
      ...
      listProcessStatus: [
        ...
        {
          label: 'document.statusReviewer.unprocessed',
          value: constants.SIGN_PROCCESS_STATUS.UNPROCESSED
        },
        {
          label: 'document.statusReviewer.processed',
          value: constants.SIGN_PROCCESS_STATUS.PROCESSED
        },
        {
          label: 'document.statusReviewer.reject',
          value: constants.SIGN_PROCCESS_STATUS.REJECTED
        }
      ],
      selectProcessStatus: { value: constants.ALL }
    }
  },
  watch: {
    showAdvance() {
