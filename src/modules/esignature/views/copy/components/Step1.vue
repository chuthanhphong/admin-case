        ...
        <div>
          ...
          <div class="col-12 row justify-space-around py-0">
            <div class="form-group col-10">
              <div class="col-12">
                <label>{{ $t('electronicSign.create.nameDocument') }}
          ...
          <div class="col-12 row justify-space-around py-0 mt-0">
            <div class="form-group col-12 col-sm-6 col-md-4 pt-0">
              <div class="col-12">
                <label>{{ $t('electronicSign.create.documentForm') }}
                  <span class="color-require">*</span></label>
                <validation-provider
                  v-slot="{ errors }"
                  name="documentType"
            ...
            <div class="form-group col-12 col-sm-6 col-md-4 pt-0">
              <div class="col-12 pt-0">
                <label>{{ $t('electronicSign.create.urgency') }}
                  <span class="color-require">*</span></label>
                <validation-provider
                  v-slot="{ errors }"
                  name="urgency"
          ...
          <div class="col-12 row justify-space-around py-0 mt-0">
            ...
            <div class="form-group col-12 col-sm-6 col-md-4 pt-0">
              <div class="col-12 pt-0">
                ...
                <small
                  v-if="promulgateGroupId"
                  class="ml-1 label-unti"
                >({{ $t('document.nextNumber') }}:
          ...
          <div class="col-12 row justify-space-around py-0">
            ...
            <div class="form-group col-12 col-sm-6 col-md-4">
              <div class="col-12">
                <label>{{ $t('electronicSign.create.fileSign') }}
                  <span class="color-require">*</span></label>
            ...
            <div class="form-group col-12 col-sm-6 col-md-4">
              <div class="col-12">
                <label>{{ $t('electronicSign.create.attachments') }}</label>
                <div class="d-flex justify-space-between align-center">
                  <validation-provider
...
export default {
  ...
  methods: {
    ...
    async initDataDocument() {
      ...
      try {
        const { data } = await DocumentService.getCopyDoc(documentId)
    ...
    async initFileDocument(data) {
      if (data.fileMainSign) {
        this.setFileDocument(data.fileMainSign)
    ...
    async selectDocumentFile() {
      try {
        ...
        if (!valid) {
          ...
          if (this.$refs.fileContract.files.length > 0) {
