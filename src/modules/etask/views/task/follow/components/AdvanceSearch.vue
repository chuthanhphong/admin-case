<template>
  <div id="dialog-search__i-create">
    ...
    <div class="dialog__body">
      <div class="item">
        <div class="mb-2">
          <label class="text--body-5">{{ $t('task-manager.dialogs.name') }}</label>
        </div>
        <validation-provider
          name="contractName"
      ...
      <div class="item">
        <div class="mb-2">
          <label class="text--body-5">{{ $t('task-manager.dialogs.state.name') }}</label>
        </div>
      ...
      <div class="item">
        <div class="mb-2">
          <label class="text--body-5">{{ $t('task-manager.label.style-task') }}</label>
        </div>
        <v-select
      ...
      <div class="item">
        <div class="mb-5">
          <label class="text--body-5">{{ $t('task-manager.dialogs.completion-deadline') }}</label>
        </div>
        <v-row class="mb-3">
          <v-col
      ...
      <div class="item">
        <div class="mb-5">
          <label class="text--body-5">{{ $t('task-manager.dialogs.priority.name') }}</label>
        </div>
        <v-row class="mb-4">
          <v-col
      ...
      <div class="item">
        <div class="mb-2">
          <label class="text--body-5">{{ $t('task-manager.dialogs.performer') }}</label>
        </div>
        <v-autocomplete
      ...
      <div class="item">
        <div class="mb-2">
          <label class="text--body-5">{{ $t('task-manager.dialogs.coordinator') }}</label>
        </div>
        <v-autocomplete
