...
<script>
import SearchDocumentArrival from "./SearchDocumentArrival.vue";
  ...
  methods: {
    ...
    onDetailDoc(item) {
      localStorage.setItem(
        ...
        constants.SEARCH_TYPE_DOCUMENT.EDOCUMENT_BOOK_ARRIVAL
      );
      this.$router.push(
