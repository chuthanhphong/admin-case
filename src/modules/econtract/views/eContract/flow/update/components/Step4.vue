  ...
  <div>
    <div class="wrap-content-contract">
      <div class="dialog-contract-detail">
        ...
        <div class="col-12 row justify-space-around">
          ...
          >
            <div class="col-12">
              <label class="text--label"> {{ $t("contract.signed") }} </label>
      ...
      <v-row justify="space-around d-none">
          ...
          <v-row align="center" class="px-3">
            ...
            <v-col>
              <div class="d-flex flex-column">
                <label class="mb-0 pr-2 text--label-1">
    ...
    <div class="d-flex justify-end align-center group-action-step">
      ...
      <v-btn
        ...
        @click="confirmSaveFlow(`${docStates.DRAFT}`)"
      >
        {{ $t("saveLabel") }}
      </v-btn>
    </div>
...
import DialogConfirmSave from "../../create/components/DialogConfirmSave.vue";
...
export default {
  ...
  methods: {
    ...
    initDataFinalize() {
      ...
      this.initScope = this.contractDetail.documentScopes;
      const scopesActive = [];
    ...
    // Confirm save
    confirmSaveFlow(docState) {
      if (!this.validateTimeSignContract()) {
        return;
      }
      this.showConfirmContract = true;
      this.docState = docState;
      this.titleConfirmSave = "flow.dialog.titleConfirmUpdate";
    },
    // Luu hop dong
    async saveContract() {
      const formData = {};
      formData.processType = "HDDT_TEMPLATE";
      formData.documentId = this.documentId;
      formData.documentScopes = this.scopes;
      ...
      try {
        ...
        message = "flow.messages.updateSuccess";
        ...
        this.$router.push(`${econtractRoute.LIST_FLOWS_PATH}`);
