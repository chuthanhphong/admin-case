        ...
        >
          <v-stepper-header class="elevation-0">
            <v-stepper-step
              ...
              class="step1-header"
            >
              <div class="text--subtitle-2 nowrap">{{ $t('contract.information') }}</div>
            </v-stepper-step>
            <v-stepper-step
            ...
            <v-stepper-step
              ...
              complete-icon=""
            >
              <div class="text--subtitle-2 nowrap">{{ $t('contract.design') }}</div>
            </v-stepper-step>
            ...
            <v-stepper-step
              ...
              class="last-step"
            >
              <div class="text--subtitle-2 nowrap">{{ $t('contract.confirm') }}</div>
            </v-stepper-step>
          </v-stepper-header>
...
export default {
  ...
  mixins: [alertMixin, goBackMethod, checkRoles],
  data() {
    return {
      currentStep: 1,
