    ...
    <div class="main__tool">
      <div class="tool__header">
        ...
        <div class="esignature-file-name">
          <div v-if="checkListFile" multiple class="tooltip-select-file" v-on="on">
            <v-select
...
import TypeSignature from '@/modules/esignature/views/create/components/TypeSignature'
import { randomId } from '@/core/utils'
import { mapState, mapActions } from 'vuex'
import DialogSelectSigner from '@/modules/esignature/views/create/components/DialogSelectSigner.vue'
import constants from '@/constants'
import DialogConfigSignature from '@/modules/esignature/views/create/components/DialogConfigSignature.vue'
...
export default {
  ...
  methods: {
    ...
    async initListSignature() {
      if (this.documentDetail.signatureSigners) {
