          ...
          <div :class="!isShowComment ? 'col-md-12' : 'col-md-6'">
            ...
            <div :style="isShowComment ? 'border-right : 2px dashed  #7A7C80;' : ''">
              ...
              <div class="clear-display row pr-5">
                ...
                <div class="col-6 col-md-9 pb-0">
                  <div class="d-flex ml-3 clear-display align-center justify-space-between progress-task">
                    <div
                    ...
                    >
                      ...
                      />
                      <span class="ml-2" v-html="fixedProgressTask(dataTask.progress)" />%
                    </div>
                    <div>
                      <v-img
                        v-if="isEditProgress"
                      ...
                      >
                        <template v-if="isEditTime" v-slot:append>
                          <div class="d-flex flex-row">
                            <v-img :src="require('@/assets/icons/task/iconSvg/repeat.svg')" />
                            <v-img
                  ...
                  >
                    ...
                    <template v-slot:selection="{ item,index }">
                      <div v-if="isEditCombinator">
                        <v-chip
                          :close="checkCurrentUserId(dataTask.combinators[index].createdBy) || checkEqualItem(dataTask.combinators[index].createdBy, null) "
                      ...
                      <div v-else>
                        ...
                        >
                          ...
                          <list-user-info-detail-task
                            ...
                            :list-participants="listCombinator"
                            :lst-colors="lstColors"
                          />
                        </v-menu>
                  ...
                  >
                    ...
                    <template v-slot:selection="{ item,index }">
                      <div v-if="isEditFollower">
                        <v-chip
                          :close="checkCurrentUserId(dataTask.monitors[index].createdBy) || checkEqualItem(dataTask.monitors[index].createdBy, null) "
                          :input-value="item.selected"
                          v-bind="item.attrs"
              ...
              <!--                cong viec con-->
              <div class="row pr-5">
                <div class="col-6 col-md-3 mt-3 pb-0">
                  <label class="v-label label-detail">
                    {{ $t('task-manager.label.task-child') }}
                  </label>
                </div>
                <div class="col-6 col-md-9 pb-0 px-3">
                  <div
                  ...
                  <div v-if="isEditChildWork" class="d-flex align-start">
                    <div class="pt-3" @click="addChildWork()">
                      <v-btn
                        ...
                        x-small
                      >
                        <v-icon color="#A7A7AB" size="28">mdi-plus-circle-outline</v-icon>
                      </v-btn>
                      <b
                        class="text pl-1 btn"
                        style="color: #A7A7AB"
...
export default {
    ...
    isEditProgress: function() {
      ...
      if (this.dataTask.performer) {
        if (this.dataTask.performer.objectType === constants.OBJECT_TYPE.GROUP) {
          temp = this.dataTask.currentUserRoles.find(user => user === constants.PERMISSION.MANAGER_PERFORMER && this.dataTask.status === constants.STATUS_TASK.FINISH)
        }
      }
      if (temp) return true
      return false
  ...
  methods: {
    ...
    async updateTask() {
      ...
      if (this.datesPicker[0]) {
        ...
        if (this.datesPicker[1]) {
          ...
          this.endTime ? this.dataTask.endDate = endDate + ' ' + this.endTime : this.dataTask.endDate = endDate + ' 00:00'
        } else {
    ...
    searchTask() {
      ...
      this.formDataSearch.taskName = null
      this.formDataSearch.taskStatuses.length = 0
      this.formDataSearch.taskStatuses.length = 0
      this.formDataSearch.taskType = null
      this.formDataSearch.deadlineTaskTimeType = null
      this.formDataSearch.estimateEndFromDate = null
      this.formDataSearch.estimateEndToDate = null
      this.formDataSearch.taskPriorities = []
      this.formDataSearch.performerIds = []
      this.formDataSearch.followerIds = []
      this.formDataSearch.combinerIds = []
