  ...
  <v-fade-transition>
    <div v-if="showDialog" class="wrap-contract-detail pa-6">
      <h4 class="text-center dialog-title white--text">
        <div>{{ $t('flow.dialog.detailFlow') }}</div>
      </h4>
                  ...
                  <v-row class="mt-0">
                    <v-col cols="12" sm="6">
                      <div class="form-group">
                        ...
                        <div v-if="contractDetail" class="detail-content text--body-1">
                    ...
                    <v-col cols="12" sm="6">
                      <div class="form-group">
                        ...
                        <div class="detail-content text--body-1 flex-start d-flex">
                          <div
                            v-if="contractDetail"
                            class="text--body-1"
...
export default {
  ...
  methods: {
    ...
    async getContractHistory() {
      try {
        this.loading = true
        const response = await ContractService.getFlowtHistory(this.contractId)
