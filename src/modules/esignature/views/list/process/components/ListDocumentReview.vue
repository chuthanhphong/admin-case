...
export default {
  ...
  data() {
    return {
      type: constants.SEARCH_TYPE_DOC.PROCESS_DOC_REVIEW
    }
  },
  methods: {
    showDetail(docId) {
      localStorage.setItem(
        ...
        constants.SEARCH_TYPE_DOC.PROCESS_DOC_REVIEW
      )
    ...
    async search() {
      try {
        ...
        this.formdata.signUserTypes = [constants.SIGN_USER_TYPE.REVIEWER]
