        ...
        <div class="col-12 row justify-space-around">
          <div class="form-group col-12 col-sm-6 col-md-4">
            <div class="col-12">
              ...
              <div v-if="documentType" class="detail-content">
          ...
          <div class="form-group col-12 col-sm-6 col-md-4">
            <div class="col-12">
              <label class="text--body-1">{{
                $t('electronicSign.create.urgency')
              }}</label>
              <div v-if="priorityId" class="detail-content">
      ...
      <v-row justify="space-around">
        ...
        <v-col class="d-flex" md="6">
          <v-row align="center">
            ...
            <label class="text--body-1 theme--light">{{
              $t('document.day')
            }}</label>
          </v-row>
        </v-col>
...
export default {
  ...
  methods: {
    ...mapActions('layout', ['setNotify', 'setFileAttachs']),
    ...
    buildDocNotRequest(signer, countGroup, countStepSign, listSigature) {
      ...
      signData.signUserId = signer.signUserId || null
