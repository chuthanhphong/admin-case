    ...
    >
      <div class="popup-list-signer-management">
        <div class="popup-header d-flex align-center justify-space-between">
          <div>
            <span>{{ $t('calendar.meetingScheduleList.list-participants') }}</span>
        ...
        <div class="list-signer">
          <div
            v-for="(signer, itemIndex) in item.participants"
            :key="itemIndex"
            class="list-item-signer pb-2"
          >
            <div class="d-flex align-center">
              <v-avatar size="32" :color="signer.groupType ? '' : lstColors[itemIndex % 5]">
                <img
              ...
              <div class="d-flex flex-column pl-2 text-left">
                <b v-if="item.participants.length === 1">{{
                  renderSignerName(signer)
                }}</b>
                <b
                  v-else
                >{{ itemIndex + 1 }}. {{ renderSignerName(signer) }}</b>
