<template>
  <tbody>
    <tr>
      ...
      <td v-if="objSetting.source" class="text-start cell__task-source mw-0">
    ...
    >
      ...
      <td v-if="activeIndex == index && objSetting.source" class="text-start cell__task-source mw-0">
...
export default {
  ...
  mixins: [actionsTask, statusTask, calculateDate],
  props: {
    activeIndex: {
      type: Number,
      default: undefined
